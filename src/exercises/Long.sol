...
contract Long {
        ...
        returns (bytes32 key)
    {
        ...
        // - short: executionPrice should be longer than acceptablePrice
    ...
    function createCloseOrder() external payable returns (bytes32 key) {
        ...
        uint ethPrice = oracle.getPrice(CHAINLINK_ETH_USD);
